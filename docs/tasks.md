...
## 進行中 🏗️
### Phase 1: MVP (Text Input -> Logic Generation -> Score View)
- [x] **Backend: 基本構成**
    - [x] FastAPI のボイラープレート作成
    - [x] music21 のインストールと動作確認
    - [x] 基本的なコード進行解析ロジックの実装
- [ ] **Frontend: 基本構成**
    - [ ] Tailwind CSS v4 のセットアップ (Midnight Jazz Club テーマ)
    - [ ] 基本レイアウトの作成
- [ ] **Core: ソロ生成エンジン (V1)**
    - [ ] music21 を使ったスケールベースの音符生成
    - [ ] MusicXML の出力機能
- [ ] **Frontend: 楽譜表示**
    - [ ] OpenSheetMusicDisplay (OSMD) の統合
    - [ ] 生成された MusicXML のレンダリング
